...
const AppProvider = ({ children })=>{
    const [incomeEntries, setIncomeEntries] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const addIncomeEntry = (newEntryData)=>{
        const newEntry = {
            ...newEntryData,
    ...
    const addExpenseToList = (expenseData)=>{
        ...
        if (typeof expenseData.date === 'string') {
            ...
            if (!isNaN(parsedDate.getTime())) {
                ...
                if (!hasTimeComponent) {
                    definitiveDate = new Date(parsedDate.getFullYear(), parsedDate.getMonth(), parsedDate.getDate(), now.getHours(), now.getMinutes(), now.getSeconds(), now.getMilliseconds());
                } else {
            ...
            const d = expenseData.date;
            if (d && !isNaN(d.getTime())) {
                const isMidnight = d.getHours() === 0 && d.getMinutes() === 0 && d.getSeconds() === 0 && d.getMilliseconds() === 0;
                if (isMidnight) {
                    definitiveDate = new Date(d.getFullYear(), d.getMonth(), d.getDate(), now.getHours(), now.getMinutes(), now.getSeconds(), now.getMilliseconds());
                } else {
                    definitiveDate = d;
                }
            } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b776f87d._.js.map